...
converting_param = {'x_range'    : 595,
                    'y_range'    : 326,
                    'x_max_px'   : 260,
                    'y_max_px'   : 200,
                    'cell_width' : 8}

path_param = {'model_path': 'Model/ebm_sdd3v',
              'data_name':  'SDD_3v_training',
              'label_csv':  'all_data.csv',
              'zip_path':   'Data/SDD_3v_training.zip', # valid for zip
              }
